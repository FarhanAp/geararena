...
<body>
    ...
    <section id="product1" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro">
                <img src="images/product/product7.webp" alt="">
                <div class="des">
                    <span>Aukey Gc-02</span>
                    <h5>Gaming Chair </h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
            ...
            <div class="pro">
                <img src="images/product/product8.avif" alt="">
                <div class="des">
                    <span>Logitech F310 GAMEPAD</span>
                    <h5>Controller Gaming </h5>
                    <div class="star">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
